...
var app_FlareElement = /*#__PURE__*/function (_HTMLElement) {
  ...
  return app_flare_element_component_createClass(FlareElement, [{
    ...
    value: function initializeFlareElement() {
      ...
      if (!flareElement.start) {
        console.error(app_Error/* ERROR_MSG */.D.COMPONENT_ATTRIBUTE_REQUIRED("start", "flare-element"));
        this.textContent = app_Error/* ERROR_MSG */.D.COMPONENT_ATTRIBUTE_MISSING("start");
        return;
      }
      if (!flareElement.flare) {
        console.error(app_Error/* ERROR_MSG */.D.COMPONENT_ATTRIBUTE_REQUIRED("flare", "flare-element"));
        this.textContent = app_Error/* ERROR_MSG */.D.COMPONENT_ATTRIBUTE_MISSING("flare");
        return;
      }
...
var app_initializeAllFlareElements = function initializeAllFlareElements() {
  document.querySelectorAll(app_Data.CUSTOM_COMPONENT.FLARE_ELEMENT.name).forEach(function (flareElement) {
    console.log("Querying: ", flareElement);
    flareElement.connectedCallback();
  });
};
document.addEventListener("DOMContentLoaded", app_initializeAllFlareElements);
customElements.define(app_Data.CUSTOM_COMPONENT.FLARE_ELEMENT.name, app_FlareElement);
;// ./src/app/index.js
/**
...
/******/ })()
;
//# sourceMappingURL=bundle-8583aaa20b2b80d84a6e.js.map