...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `@font-face{font-family:"SpaceMono";src:url(${___CSS_LOADER_URL_REPLACEMENT_0___}) format("truetype");font-weight:400;font-style:normal}@font-face{font-family:"SpaceMono";src:url(${___CSS_LOADER_URL_REPLACEMENT_1___}) format("truetype");font-weight:700;font-style:normal}@font-face{font-family:"SpaceMono";src:url(${___CSS_LOADER_URL_REPLACEMENT_2___}) format("truetype");font-weight:400;font-style:italic}@font-face{font-family:"SpaceMono";src:url(${___CSS_LOADER_URL_REPLACEMENT_3___}) format("truetype");font-weight:700;font-style:italic}body{font-family:"SpaceMono";font-size:12px;line-height:14px;letter-spacing:-0.6px}*{scrollbar-width:thin}body{background-color:#111;color:#fff;height:100vh;overflow:hidden}#main-container{height:93%;display:grid;grid-template-columns:min-content auto;column-gap:.5rem}.container-block{position:relative;border:1px solid hsla(0,0%,100%,.1);padding:.36rem}.main-scroll-block{overflow-y:auto;height:95vh}#left-section,#right-section{display:grid;gap:.5rem}@media(max-width: 575.98px){#main-container{grid-template-columns:1fr;gap:.25rem}#left-section,#right-section{gap:.25rem}.container-block{padding:.25rem}}@media(min-width: 576px)and (max-width: 767.98px){#main-container{grid-template-columns:1fr 2fr}.container-block{padding:.3rem}}@media(min-width: 768px)and (max-width: 991.98px){#main-container{grid-template-columns:min-content auto}.container-block{padding:.36rem}#left-section,#right-section{gap:.5rem}}@media(min-width: 992px)and (max-width: 1199.98px){#main-container{grid-template-columns:min-content auto}.container-block{padding:.4rem}}@media(min-width: 1200px){#main-container{grid-template-columns:min-content auto}.container-block{padding:.5rem}}.dev-info{display:block;justify-content:center}.dev-info header{display:grid;gap:.25rem}.dev-info span,.dev-communities span,.dev-tech span{padding-left:.25rem;padding-right:.25rem;background-color:#fff;color:#000}.dev-marquee{position:absolute;bottom:0px;left:0px;right:0px;margin-top:auto;background-color:#000}.dev-communities{margin-bottom:3rem}.dev-info .span-container,.dev-communities .span-container{display:grid;gap:.25rem;grid-template-columns:max-content auto}.dev-tech .span-container{display:grid;gap:.25rem;grid-template-columns:max-content max-content max-content}.dev-profile{padding:.25rem;border:1px solid hsla(0,0%,100%,.1);width:min-content;left:0px;right:0px;margin:auto}.dev-img{width:150px;height:149px;overflow:hidden;position:relative;background-color:hsla(0,0%,100%,.1)}.dev-img img{position:absolute;width:fit-content;height:300px;transform:translate(-450px);object-fit:cover}.marquee{background-color:#f9cd26;color:#111;position:absolute;bottom:0;left:0;width:100%;overflow:hidden;--marquee-play: running}.marquee__items{display:flex;white-space:nowrap;animation:marqueeScroll 5s linear infinite;animation-play-state:var(--marquee-play)}.marquee__item{display:inline-block;margin-right:.5rem}@keyframes marqueeScroll{0%{transform:translateX(0%)}100%{transform:translateX(-158%)}}`, "",{"version":3,"sources":["webpack://./src/app/scss/abstracts/_mixins.scss","webpack://./src/app/scss/base/_typography.scss","webpack://./src/