...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `@font-face{font-family:"SpaceMono";src:url(${___CSS_LOADER_URL_REPLACEMENT_0___}) format("truetype");font-weight:400;font-style:normal}@font-face{font-family:"SpaceMono";src:url(${___CSS_LOADER_URL_REPLACEMENT_1___}) format("truetype");font-weight:700;font-style:normal}@font-face{font-family:"SpaceMono";src:url(${___CSS_LOADER_URL_REPLACEMENT_2___}) format("truetype");font-weight:400;font-style:italic}@font-face{font-family:"SpaceMono";src:url(${___CSS_LOADER_URL_REPLACEMENT_3___}) format("truetype");font-weight:700;font-style:italic}body{font-family:"SpaceMono",monospace;font-display:swap;font-size:12px;line-height:14px;letter-spacing:-0.6px}*{scrollbar-width:thin}body{background-color:#111;color:#fff;height:100vh;overflow:hidden}#main-container{height:93%;display:grid;grid-template-columns:min-content auto;column-gap:.5rem}.container-block{position:relative;border:1px solid hsla(0,0%,100%,.1);padding:.36rem}.page-loader{display:none}.main-scroll-block{display:block;overflow-y:auto;height:95vh}#left-section,#right-section{display:grid}#left-section{gap:.5rem}@media(max-width: 575.98px){#main-container{grid-template-columns:1fr;gap:.25rem}#left-section,#right-section{gap:.25rem}.container-block{padding:.25rem}.main-scroll-block{overflow-y:scroll}}@media(min-width: 576px)and (max-width: 767.98px){#main-container{grid-template-columns:1fr 2fr}.container-block{padding:.3rem}.main-scroll-block{overflow-y:scroll}}@media(min-width: 768px)and (max-width: 991.98px){#main-container{grid-template-columns:min-content auto}.container-block{padding:.36rem}#left-section,#right-section{gap:.5rem}.main-scroll-block{overflow-y:scroll}}@media(min-width: 992px)and (max-width: 1199.98px){#main-container{grid-template-columns:min-content auto}.container-block{padding:.4rem}}@media(min-width: 1200px){#main-container{grid-template-columns:min-content auto}.container-block{padding:.5rem}}.dev-info{display:block;justify-content:center}.dev-info header{display:grid;gap:.25rem}.dev-info span,.dev-communities span,.dev-tech span{padding-left:.25rem;padding-right:.25rem;background-color:#fff;color:#000}.dev-marquee{position:absolute;bottom:0px;left:0px;right:0px;margin-top:auto;background-color:#000}.dev-communities{margin-bottom:3rem}.dev-info .span-container,.dev-communities .span-container{display:grid;gap:.25rem;grid-template-columns:max-content auto}.dev-tech .span-container{display:grid;gap:.25rem;grid-template-columns:max-content max-content max-content}.dev-profile{padding:.25rem;border:1px solid hsla(0,0%,100%,.1);width:min-content;left:0px;right:0px;margin:auto}.dev-img{width:150px;height:150px;overflow:hidden;position:relative;background-color:hsla(0,0%,100%,.1)}.dev-img img{position:absolute;width:fit-content;height:201%;transform:translate(-75%);object-fit:cover}@media(max-width: 575.98px){.dev-tech .span-container{grid-template-columns:repeat(4, 1fr)}}@media(max-width: 414.98px){.dev-tech .span-container{grid-template-columns:repeat(3, 1fr)}}@media(max-width: 320.98px){.dev-tech .span-container{grid-template-columns:repeat(2, 1fr)}}.marquee{background-color:#f9cd26;color:#111;position:absolute;bottom:0;left:0;width:100%;overflow:hidden;--marquee-play: running;--marquee-speed: 33s;box-shadow:0 0 9px 1px #f9cd26;animation:cyberpunk-pulse-1px-9px 1.5s infinite alternate}@keyframes cyberpunk-pulse-1px-9px{0%{box-shadow:0 0 calc(9px/2) calc(1px/2) rgba(249,205,38,.8)}100%{box-shadow:0 0 9px 1px rgba(249,205,38,.5)}}.marquee__items{display:flex;white-space:nowrap;animation:marqueeScroll var(--marquee-speed) linear infinite;animation-play-state:var(--marquee-play);will-change:transform;width:max-content;line-height:1.1rem;font-weight:900}.marquee__item{display:inline-block;margin-right:.5rem}@keyframes marqueeScroll{from{transform:translateX(0%)}to{transform:translateX(-50%)}}`,